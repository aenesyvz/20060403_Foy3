...
--SELECT calisan_birim_id, COUNT (calisan_birim_id) AS 'Calisan Sayisi' FROM calisanlar GROUP BY calisan_birim_id

--SELECT unvan_calisan, COUNT (unvan_calisan) AS 'Calisan Sayisi' FROM unvan GROUP BY unvan_calisan HAVING COUNT (unvan_calisan) > 1
